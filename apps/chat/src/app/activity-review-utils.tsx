...
export const BADGE_INACTIVE_STYLES: Record<string, string> = {
  reasoning: 'hover:bg-primary/10 hover:text-primary hover:border-primary/30',
  ...
  tool_call: 'hover:bg-primary/10 hover:text-amber-400 hover:border-amber-500/30',
...
const HIGHLIGHT_MARK_CLASS =
  'bg-amber-400/40 text-amber-950 dark:bg-amber-400/50 dark:text-primary rounded px-0.5';
const SUSPICIOUS_SEGMENT_CLASS =
  'bg-primary/25 text-primary border-b border-amber-500/50 rounded-sm px-0.5';
